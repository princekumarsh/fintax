            ...
            <div class="col-md-12 col-lg-12">
                <div class="card-header d-flex justify-content-between">
                   <div class="header-title">
                      <h4 class="card-title">BALANCE TRANSFER + HOME LOAN FOR SALARIED PERSON</h4>
                   </div>
                </div>
                                ...
                                @foreach($homeLoan as $h)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('admin.home_loan_salaried_btDelete',[$h->id])}}" onclick="return confirm('Are you sure?')"><i class="fa-solid fa-trash text-danger"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
