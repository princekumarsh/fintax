            ...
            <div class="col-md-12 col-lg-12">
                <div class="card-header d-flex justify-content-between">
                   <div class="header-title">
                      <h4 class="card-title">Limited Company</h4>
                   </div>
                </div>
                                ...
                                @foreach($partnership as $p)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('admin.gst_reg_ltdCompany.delete',[$p->id])}}" onclick="return confirm('Are you sure?')"><i class="fa-solid fa-trash text-danger"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
