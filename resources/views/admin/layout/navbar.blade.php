<nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
                <div class="container-fluid navbar-inner">
                    <a href="#" class="navbar-brand">
                        ...
                        <!--</svg>-->
                        <!--logo End-->
                        <h4 class="logo-title">Fintax Bazar</h4>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                            ...
                            <!--        <img src="/backend/assets/images/Flag/flag001.png" class="img-fluid rounded-circle"-->
                            ...
                            <!--                            href="#"><img src="/backend/assets/images/Flag/flag-03.png"-->
                            <!--                                alt="img-flaf" class="img-fluid me-2"-->
                            <!--                                style="width: 15px;height: 15px;min-width: 15px;" />Spanish</a>-->
                            <!--                    </li>-->
                            <!--                    <li class="iq-sub-card list-group-item"><a class="p-0"-->
                            <!--                            href="#"><img src="/backend/assets/images/Flag/flag-04.png"-->
                            <!--                                alt="img-flaf" class="img-fluid me-2"-->
                            <!--                                style="width: 15px;height: 15px;min-width: 15px;" />Italian</a>-->
                            <!--                    </li>-->
                            <!--                    <li class="iq-sub-card list-group-item"><a class="p-0"-->
                            <!--                            href="#"><img src="/backend/assets/images/Flag/flag-02.png"-->
                            <!--                                alt="img-flaf" class="img-fluid me-2"-->
                            <!--                                style="width: 15px;height: 15px;min-width: 15px;" />French</a>-->
                            <!--                    </li>-->
                            <!--                    <li class="iq-sub-card list-group-item"><a class="p-0"-->
                            <!--                            href="#"><img src="/backend/assets/images/Flag/flag-05.png"-->
                            <!--                                alt="img-flaf" class="img-fluid me-2"-->
                            <!--                                style="width: 15px;height: 15px;min-width: 15px;" />German</a>-->
                            <!--                    </li>-->
                            <!--                    <li class="iq-sub-card list-group-item"><a class="p-0"-->
                            <!--                            href="#"><img src="/backend/assets/images/Flag/flag-06.png"-->
                            <!--                                alt="img-flaf" class="img-fluid me-2"-->
                            ...
                            <!--                            src="/backend/assets/images/shapes/01.png" alt="">-->
                            ...
                            <!--                        <div class="">-->
                            <!--                            <img class="p-1 avatar-40 rounded-pill bg-soft-primary"-->
                            <!--                                src="/backend/assets/images/shapes/02.png" alt="">-->
                            <!--                        </div>-->
                            <!--                        <div class="ms-3 w-100">-->
                            ...
                            <!--                    <div class="d-flex align-items-center">-->
                            <!--                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"-->
                            <!--                            src="/backend/assets/images/shapes/03.png" alt="">-->
                            <!--                        <div class="ms-3 w-100">-->
                            ...
                            <!--                    <div class="d-flex align-items-center">-->
                            <!--                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"-->
                            <!--                            src="/backend/assets/images/shapes/04.png" alt="">-->
                                        ...
                                        <div class="p-0 card-body ">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <div class="">
                                                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                            src="/backend/assets/images/shapes/05.png" alt="">
                                                    </div>
                                                    <div class="ms-3">
                            ...
                            <li class="nav-item dropdown">
                                <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown"
                                    ...
                                    <img src="{{asset('public/backend/assets/images/avatars/01.png')}}" alt="User-Profile"
                                        class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded">
                                    <img src="{{asset('public/backend/assets/images/avatars/avtar_1.png')}}" alt="User-Profile"
                                        class="theme-color-purple-img img-fluid avatar avatar-50 avatar-rounded">
                                    <img src="{{asset('public/backend/assets/images/avatars/avtar_2.png')}}" alt="User-Profile"
                                        class="theme-color-blue-img img-fluid avatar avatar-50 avatar-rounded">
                                    <img src="{{asset('public/backend/assets/images/avatars/avtar_4.png')}}" alt="User-Profile"
                                        class="theme-color-green-img img-fluid avatar avatar-50 avatar-rounded">
                                    <img src="{{asset('public/backend/assets/images/avatars/avtar_5.png')}}" alt="User-Profile"
                                        class="theme-color-yellow-img img-fluid avatar avatar-50 avatar-rounded">
                                    <img src="{{asset('public/backend/assets/images/avatars/avtar_3.png')}}" alt="User-Profile"
                                        class="theme-color-pink-img img-fluid avatar avatar-50 avatar-rounded">
                                    <div class="caption ms-3 d-none d-md-block ">
                                        <h6 class="mb-0 caption-title">@if (Auth('associated')->user())
                                            {{Auth('associated')->user()->name}}
                                        @else
                                        {{Auth::user()->name}}
                                        @endif </h6>
