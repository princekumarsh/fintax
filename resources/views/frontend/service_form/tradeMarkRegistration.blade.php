        	...
        	<div>
      			<div class="row">
        			<div class="mx-auto col-10 col-md-8 col-lg-6">
                    	<!-- Form -->
                    	<form class="form-example" action="{{route('service.tradeMarkRegistrationPost')}}" method="post" enctype="multipart/form-data">
                                @csrf
            				<h3>TRADE MARK CERTIFICATION REGISTRATION (Rate RS 3599/ + GOV FEE-)</h3>
            				<!-- Input fields -->
                                          ...
                                          <label for="method" style="color:black;">
                                            ...
                                            <div class="row">
                                                 <div class="col-lg-4 col-md-4 col-12">
                                                        ...
                                                        <label id="fulls">Full Payment (RS 3599)</label><br>
                                                 </div>
                                                 <div class="col-lg-4 col-md-4 col-12">
                                                 ...
                                                 <img src="{{asset('public/assets/images/payment/rs-3599.jpg')}}" style="height: 350px" id="img-1">
                                   ...
                                   <h3 class="text-danger">&#129155 Optional Documents</h3>
                                        ...
                                        <div class="form-group">
                                                <label for="pan" style="color:black;">INDIVIDUALS </label>
                                                <label for="pan" style="color:black;">- Pan Card:</label>
                                                <input type="file" class="form-control" name="indi_pan_card"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="pan" style="color:black;">INDIVIDUALS </label>
                                                <label for="aadhar" style="color:black;">- Aadhar Card:</label>
                                                <input type="file" class="form-control" name="indi_aadhar_card"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="photo" style="color:black;">INDIVIDUALS </label>
                                                <label for="photo" style="color:black;">- Photo:</label>
                                                <input type="file" class="form-control" name="indi_photo"/>
                                        </div>
                                        <div class="form-group">
                                                <label for="gst" style="color:black;">GST CERTIFICATE</label>
                                                <input type="file" class="form-control" name="gst_certi"/>
                                        </div>
                                        <div class="form-group">
                                                <label for="ltName" style="color:black;">LOGO & TRADE MARK NAME</label>
                                                <input type="file" class="form-control" name="trade_mark_Name"/>
                                        </div>
                                        <div class="form-group">
                                                <label for="affidavit" style="color:black;">AFFIDAVIT WITH 50 RS STAMP DUTY</label>
                                                <input type="file" class="form-control" name="affidavit"/>
                                        </div>
