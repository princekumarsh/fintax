        	...
        	<div>
      			<div class="row">
        			<div class="mx-auto col-10 col-md-8 col-lg-6">
                    	<!-- Form -->
                    	<form class="form-example" action="{{route('service.pvtLtdAndOtherCompany1Post')}}" method="post" enctype="multipart/form-data">
                            @csrf
            				<h3>PVT. LTD. & OTHER COMPANY( UP TO 1.5 CR) (Rate RS 21500/-)</h3>
            				<!-- Input fields -->
                                        <input type="hidden" name="reg_type" value="pvt ltd(up to 1.5)">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="row">
                                                 <div class="col-lg-4 col-md-4 col-12">
                                                        ...
                                                        <label id="fulls">Full Payment (RS 21500)</label><br>
                                                 </div>
                                                 <div class="col-lg-4 col-md-4 col-12">
                                                 ...
                                                 <img src="{{asset('public/assets/images/payment/rs-21500.jpg')}}" style="height: 350px" id="img-1">
