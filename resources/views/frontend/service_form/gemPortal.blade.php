        	...
        	<div>
      			<div class="row">
        			<div class="mx-auto col-10 col-md-8 col-lg-6">
                        <h3>GEM PORTAL  REGISTRATION</h3>
                    	<!-- Form -->
                    	<form class="form-example" action="{{route('service.gemPortalPost')}}" method="post" enctype="multipart/form-data">
                            @csrf
            				<!-- Input fields -->
                            <input type="hidden" name="reg_type" value="gem_portal">
