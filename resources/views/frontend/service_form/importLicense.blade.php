        	...
        	<div>
      			<div class="row">
        			<div class="mx-auto col-10 col-md-8 col-lg-6">
                    	<!-- Form -->
                    	<form class="form-example" action="{{route('service.importLicensePost')}}" method="post" enctype="multipart/form-data">
            				<h3>IMPORT EXPORT LICENSE REGISTRATION</h3>
            				<!-- Input fields -->
                            @csrf
                            <input type="hidden" name="reg_type" value="import_license">
