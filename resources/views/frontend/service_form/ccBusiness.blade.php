        	...
        	<div>
      			<div class="row">
        			<div class="mx-auto col-10 col-md-8 col-lg-6">
                    	<!-- Form -->
                    	<form class="form-example" action="{{route('service.ccBusinessPost')}}" method="post">
                                @csrf
            				<h3>CREDIT CARD
                                FOR BUSINESS MAN </h3>
            				<!-- Input fields -->
                                        ...
                                        <div class="form-group">
                                                <label for="gst" style="color:black;">Business Registration Proof:<span class="asterisk">*</span></label>
                                        ...
                                        <div class="form-group">
                                                <label for="gst" style="color:black;">2 Years ITR With Computation Sheet:<span class="asterisk">*</span></label>
