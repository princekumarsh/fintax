        	...
        	<div>
      			<div class="row">
        			<div class="mx-auto col-10 col-md-8 col-lg-6">
                    	<!-- Form -->
                    	<form class="form-example" action="{{route('service.itr_selfEmployedPost')}}" method="post" enctype="multipart/form-data">
                                @csrf
            				<h3>SELF-EMPLOYED PERSON'S (Rate RS 499/-)</h3>
            				<!-- Input fields -->
                                        <input type="hidden" value="self-employed" name="itr">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="row">
                                                 <div class="col-lg-4 col-md-4 col-12">
                                                        ...
                                                        <label id="fulls">Full Payment (RS 499)</label><br>
                                                 </div>
                                                 <!-- <div class="col-lg-4 col-md-4 col-12">
                                                 ...
                                                 <img src="{{asset('public/assets/images/payment/rs-499.jpg')}}" style="height: 350px" id="img-1">
