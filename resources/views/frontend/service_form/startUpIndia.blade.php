        ...
        <div>
            <div class="row">
                <div class="mx-auto col-10 col-md-8 col-lg-6">
                    <!-- Form -->
                    <form class="form-example" action="{{ route('service.startUpIndiaPost') }}" method="post"
                        enctype="multipart/form-data">
                        <h3>START UP INDIA REGISTRATION</h3>
                        @csrf
                        <!-- Input fields -->
                        <input type="hidden" name="reg_type" value="startUpIndia">
