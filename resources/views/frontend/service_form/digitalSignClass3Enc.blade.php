        	...
        	<div>
      			<div class="row">
        			<div class="mx-auto col-10 col-md-8 col-lg-6">
                    	<!-- Form -->
                    	<form class="form-example" action="{{route('service.digitalSignClass3EncPost')}}" method="post" enctype="multipart/form-data">
                                @csrf
            				<h3>DIGITAL SIGNATURE CERTIFICATE CLASS-3( SIGNATURE+ ENCRUPTION)  &nbsp;&nbsp;RS 2049/-</h3>
            				<!-- Input fields -->
                                        <input type="hidden" name="reg_type" value="digital_signature3Enc">
                        ...
                        <div class="form-group">
                          ...
                          <div class="row">
                                 <div class="col-lg-4 col-md-4 col-12">
                                        ...
                                        <label id="fulls">Full Payment (RS 2049)</label><br>
                                 </div>
                                 <div class="col-lg-4 col-md-4 col-12">
                                 ...
                                 <img src="{{asset('public/assets/images/payment/rs-2049.jpg')}}" style="height: 350px" id="img-1">
