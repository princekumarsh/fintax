        	...
        	<div>
      			<div class="row">
        			<div class="mx-auto col-10 col-md-8 col-lg-6">
                    	<!-- Form -->
                    	<form class="form-example" action="{{route('service.ccSalariedPost')}}" method="post" enctype="multipart/form-data">
                                @csrf
            				<h3>CREDIT CARD
            				...
            				<!-- Input fields -->
                                        ...
                                        <div class="form-group">
                                                <label for="gst" style="color:black;">3 Month Salary Slip:<span class="asterisk">*</span></label>
                                        ...
                                        <div class="form-group">
                                                <label for="gst" style="color:black;">1 Year Form 16/26AS:<span class="asterisk">*</span></label>
