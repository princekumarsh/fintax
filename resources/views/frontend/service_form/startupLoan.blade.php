        ...
        <div>
            <div class="row">
                <div class="mx-auto col-10 col-md-8 col-lg-6">
                    <!-- Form -->
                    <form class="form-example" action="{{ route('service.startupLoanPost') }}" method="post"
                        ...
                        <div class="form-group">
                            <label for="ca_pan" style="color:black;">CO-APPLICANT KYC PAPER - PAN
                                CARD:</label>
                            <input type="file" class="form-control" name="ca_pan_card">
                        </div>
                        <div class="form-group">
                            <label for="aadhar" style="color:black;">CO-APPLICANT KYC PAPER - AADHAR
                                CARD:</label>
                            <input type="file" class="form-control" name="ca_aadhar_card">
                        </div>
                        <div class="form-group">
                            <label for="photo" style="color:black;">CO-APPLICANT KYC PAPER -
                                PHOTO:</label>
                            <input type="file" class="form-control" name="ca_photo">
                        </div>
                        <div class="form-group">
                            <label for="property_paper" style="color:black;">PROPERTY PAPER WITH ALL
                                CHAIN DEED:</label>
                            <input type="file" class="form-control" name="property_paper">
                        </div>
                        <div class="form-group">
                            <label for="property_paper" style="color:black;">Project Report:</label>
                            <input type="file" class="form-control" name="project_report">
                        </div>
