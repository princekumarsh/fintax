    ...
    <div>
        <div class="row">
            <div class="mx-auto col-10 col-md-8 col-lg-6">
                <!-- Form -->
                <form class="form-example" action="{{route('service.isoRegistrationPost')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <h3>ISO CERTIFICATIONS REGISTRATION</h3>
                    <!-- Input fields -->
                    <input type="hidden" name="reg_type" value="iso_certi_reg">
