...
<!-- Main content Start -->
        <div class="main-content">      
                <div>
                        ...
                        <!-- Form -->
                        <form class="form-example" action="{{route('service.gst_reg_pvtltdComPost')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                        <h3>PRIVATE LIMITED COMPANY (Rate RS 1499/-)</h3>
                                        <!-- Input fields -->
                                        ...
                                        <input type="hidden" name="pvt_ltd_com" value="Pvt. Ltd. Company">
