        	...
        	<div>
      			<div class="row">
        			<div class="mx-auto col-10 col-md-8 col-lg-6">
                    	<!-- Form -->
                    	<form class="form-example" action="{{route('service.pvtLtdAndOtherCompany2Post')}}" method="post" enctype="multipart/form-data">
                            @csrf
            				<h3>PVT. LTD. & OTHER COMPANY(ABOVE 1.5 CR) (Rate RS 25500/-)</h3>
            				<!-- Input fields -->
                                        <input type="hidden" name="reg_type" value="pvt ltd(above 1.5)">
                                    ...
                                    <div class="form-group">
                                          ...
                                          <div class="row">
                                                 <div class="col-lg-4 col-md-4 col-12">
                                                        ...
                                                        <label id="fulls">Full Payment (RS 25500)</label><br>
                                                 </div>
                                                 <div class="col-lg-4 col-md-4 col-12">
                                                 ...
                                                 <img src="{{asset('public/assets/images/payment/rs-25500.jpg')}}" style="height: 350px" id="img-1">
