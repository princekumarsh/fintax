...
<!-- Main content Start -->
        <div class="main-content">      
                <div>
                        ...
                        <!-- Form -->
                        <form class="form-example" action="{{route('service.gst_reg_nidhiCompanyPost')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                        <h3>NIDHI COMPANY (Rate RS 1499/-)</h3>
                                        <!-- Input fields -->
                                       
                                        <input type="hidden" name="nidhi_com" value="Nidhi Company">
