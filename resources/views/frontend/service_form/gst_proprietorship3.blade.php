        	...
        	<div>
      			<div class="row">
        			<div class="mx-auto col-10 col-md-8 col-lg-6">
                    	<!-- Form -->
                    	<form class="form-example" action="{{route('service.gst_proprietorship3Post')}}" method="post" enctype="multipart/form-data">
                            @csrf
            				<h3>PROPRIETORSHIP( TURN OVER  5 CR TO ABOVE) (Rate RS 24000/-)</h3>
            				<!-- Input fields -->
                                        <input type="hidden" name="reg_type" value="propri(5cr to above)">
                                    ...
                                    <div class="form-group">
                                          ...
                                          <div class="row">
                                                 <div class="col-lg-4 col-md-4 col-12">
                                                        ...
                                                        <label id="fulls">Full Payment (RS 24000)</label><br>
                                                 </div>
                                                 <div class="col-lg-4 col-md-4 col-12">
                                                 ...
                                                 <img src="{{asset('public/assets/images/payment/rs-24000.jpg')}}" style="height: 350px" id="img-1">
