        	...
        	<div>
      			<div class="row">
        			<div class="mx-auto col-10 col-md-8 col-lg-6">
                    	<!-- Form -->
                    	<form class="form-example" action="{{route('service.balancesheet_proprietorshipPost')}}" method="post" enctype="multipart/form-data">
                                @csrf
            				<h3>PROPRIETORSHIP( COMPOSITION) (Rate RS 4000/- ANNUAL)</h3>
            				<!-- Input fields -->
                                         ...
                                         <div class="form-group">
                                          ...
                                          <div class="row">
                                                 <div class="col-lg-4 col-md-4 col-12">
                                                        ...
                                                        <label id="fulls">Full Payment (RS 4000)</label><br>
                                                 </div>
                                                 <div class="col-lg-4 col-md-4 col-12">
                                                 ...
                                                 <img src="{{asset('public/assets/images/payment/rs-4000.jpg')}}" style="height: 350px" id="img-1">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="form-group">
                                                <label for="cmp" style="color:black;">
                                               CMP-08 QTR RETURN:</label>
                                                <input type="file" class="form-control" name="qtr_return"/>
                                        </div>
                                        <div class="form-group">
                                                <label for="annualreturn" style="color:black;">
                                              ANNUAL RETURN (UP TO 1.5 CR) :</label>
                                                <input type="file" class="form-control" name="annual_return"/>
                                        </div>
