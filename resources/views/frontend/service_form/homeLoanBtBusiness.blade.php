        	...
        	<div>
      			<div class="row">
        			<div class="mx-auto col-10 col-md-8 col-lg-6">
                    	<!-- Form -->
                    	<form class="form-example" action="{{route('service.homeLoanBtBusinessPost')}}" method="post" enctype="multipart/form-data">
                            @csrf
            				<h3>BALANCE TRANSFER + HOME LOAN
                                FOR BUSINESS MAN</h3>
            				<!-- Input fields -->
                   ...
                   <div class="form-group">
                    ...
                    <h3 class="text-danger">&#129155 Optional Documents</h3>
                            ...
                            <div class="form-group">
                                <label for="gst_reg" style="color:black;">GST REGISTRATION( IF GSTIN PERSON):</label>
                            ...
                            <div class="form-group">
                                <label for="loan_statement" style="color:black;">ALL LOAN TRACK & LOAN STATEMENT:</label>
                                <input type="file" class="form-control" name="loan_statement">
                            </div>
                            <div class="form-group">
                                <label for="lod" style="color:black;">LIST OF DOCUMENTS(LOD):</label>
                                <input type="file" class="form-control" name="lod">
                            </div>
