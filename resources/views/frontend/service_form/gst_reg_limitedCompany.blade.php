...
<!-- Main content Start -->
        <div class="main-content">      
                <div>
                        ...
                        <!-- Form -->
                        <form class="form-example" action="{{route('service.gst_reg_limitedCompanyPost')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                        <h3>LIMITED COMPANY (Rate RS 1499/-)</h3>
                                        <!-- Input fields -->
                                        ...
                                        <input type="hidden" name="ltd_com" value="Ltd. Company">
