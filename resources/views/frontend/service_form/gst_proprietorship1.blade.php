        	...
        	<div>
      			<div class="row">
        			<div class="mx-auto col-10 col-md-8 col-lg-6">
                    	<!-- Form -->
                    	<form class="form-example" action="{{route('service.gst_proprietorship1Post')}}" method="post" enctype="multipart/form-data">
                            @csrf
            				<h3>PROPRIETORSHIP( TURN OVER UP TO 1.5 CR) (Rate RS 6000/- ANNUAL)</h3>
            				<!-- Input fields -->
                                    <input type="hidden" name="reg_type" value="propri(up to 1.5)">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="row">
                                                 <div class="col-lg-4 col-md-4 col-12">
                                                        ...
                                                        <label id="fulls">Full Payment (RS 6000)</label><br>
                                                 </div>
                                                 <div class="col-lg-4 col-md-4 col-12">
                                                 ...
                                                 <img src="{{asset('public/assets/images/payment/rs-6000.jpg')}}" style="height: 350px" id="img-1">
